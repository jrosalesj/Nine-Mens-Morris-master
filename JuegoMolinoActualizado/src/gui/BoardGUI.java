...
public class BoardGUI extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        jLabelJugador1.setText("P1:"+UsuarioB.jugador1);
        jLabelJugador1.setBounds(610, 60, 200, 25);
        add(jLabelJugador1);
        ...
        jLabelJugador2.setText("P2:"+UsuarioN.jugador2);             
        jLabelJugador2.setBounds(610, 320, 200, 25);
        add(jLabelJugador2);
    ...
    private class Controller extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            for (int i = 0; i < 24; i++) {
                ...
                if (coords.x - getSize().height/30 <= x && x <= coords.x + getSize().height/30 && coords.y - getSize().height/30 <= y && y <= coords.y + getSize().height/30) {
                    if (isAIMode == 0){
